...
//
// There is no lost-item reporting anywhere in this app: the student-facing
// concept is found property -> Student Union custody -> public listing ->
// claim -> verification -> return. The backend still has a lost-item
// endpoint (kept intentionally — see the implementation report), but
// nothing in this frontend calls it or assumes `type: "lost"` exists.
function App() {
